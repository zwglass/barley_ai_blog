  ...
  [408],
  {
    7408: (t, e, i) => {
      ...
      let r = globalThis,
        ...
        b = (t, e) => !u(t, e),
        C = { attribute: !0, type: String, converter: E, reflect: !1, hasChanged: b }
      ...
      class w extends HTMLElement {
        ...
        _$EC(t, e) {
          ...
          if (void 0 !== r && !0 === s.reflect) {
            let n = (
              (null == (i = s.converter) ? void 0 : i.toAttribute) !== void 0 ? s.converter : E
            ...
            let t = s.getPropertyOptions(r),
              n =
                'function' == typeof t.converter
                  ...
                  : (null == (i = t.converter) ? void 0 : i.fromAttribute) !== void 0
                    ? t.converter
                    : E
        ...
        requestUpdate(t, e, i) {
          if (void 0 !== t) {
            if (
              (i ?? (i = this.constructor.getPropertyOptions(t)), !(i.hasChanged ?? b)(this[t], e))
            )
              return
            this.P(t, e, i)
          }
        ...
        P(t, e, i) {
          this._$AL.has(t) || this._$AL.set(t, e),
            !0 === i.reflect && this._$Em !== t && (this._$Ej ?? (this._$Ej = new Set())).add(t)
        }
        async _$ET() {
      ...
      let U = globalThis,
        ...
        k = Array.isArray,
        L = (t) => k(t) || 'function' == typeof (null == t ? void 0 : t[Symbol.iterator]),
        D = `[ 	
\f\r]`,
        j = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,
        z = /-->/g,
...
\f\r"'\`<>=]|("|')|))|$)`,
      ...
      let X = (t, e) => {
        ...
        for (let e = 0; e < i; e++) {
          let i = t[e],
            ...
            a = -1,
            d = 0
          for (; d < i.length && ((o.lastIndex = d), null !== (h = o.exec(i))); )
            (d = o.lastIndex),
              o === j
                ? '!--' === h[1]
                  ? (o = z)
        ...
        return [Z(t, n + (t[i] || '<?>') + (2 === e ? '</svg>' : 3 === e ? '</math>' : '')), s]
      }
      class tt {
                ...
                for (let t of s.getAttributeNames())
                  if (t.endsWith(M)) {
                    ...
                    l.push({
                      ...
                      name: o[2],
                      strings: i,
                      ctor: '.' === o[1] ? tn : '?' === o[1] ? to : '@' === o[1] ? tl : tr,
                    }),
                      s.removeAttribute(t)
                  } else t.startsWith(N) && (l.push({ type: 6, index: r }), s.removeAttribute(t))
              if (V.test(s.tagName)) {
                ...
                if (e > 0) {
                  ...
                  for (let i = 0; i < e; i++)
                    s.append(t[i], x()), Q.nextNode(), l.push({ type: 2, index: ++r })
                  s.append(t[e], x())
                }
              }
      ...
      class ts {
        ...
        get parentNode() {
          let t = this._$AA.parentNode,
            e = this._$AM
          return void 0 !== e && (null == t ? void 0 : t.nodeType) === 11 && (t = e.parentNode), t
        }
        get startNode() {
          return this._$AA
        }
        ...
        $(t) {
          ...
          let { values: i, _$litType$: s } = t,
            r =
              'number' == typeof s
                ? this._$AC(t)
                : (void 0 === s.el && (s.el = tt.createElement(Z(s.h, s.h[0]), this.options)), s)
        ...
        _$AC(t) {
          ...
          return void 0 === e && J.set(t.strings, (e = new tt(t))), e
        }
        k(t) {
          ...
          for (let r of t)
            s === e.length
              ? e.push((i = new ts(this.O(x()), this.O(x()), this, this.options)))
              : (i = e[s]),
              i._$AI(r),
              s++
      ...
      class tr {
        ...
        _$AI(t, e = this, i, s) {
          let r = this.strings,
            n = !1
          if (void 0 === r)
            (n = !H((t = te(this, t, e, 0))) || (t !== this._$AH && t !== K)) && (this._$AH = t)
          else {
            let s, o
            let l = t
            for (t = r[0], s = 0; s < r.length - 1; s++)
              (o = te(this, l[i + s], e, s)) === K && (o = this._$AH[s]),
                n || (n = !H(o) || o !== this._$AH[s]),
                o === F ? (t = F) : t !== F && (t += (o ?? '') + r[s + 1]),
                (this._$AH[s] = o)
          }
          n && !s && this.j(t)
        }
      ...
      class tl extends tr {
        ...
        handleEvent(t) {
          ...
          'function' == typeof this._$AH
            ? this._$AH.call((null == (e = this.options) ? void 0 : e.host) ?? this.element, t)
      ...
      null == ta || ta(tt, ts), (U.litHtmlVersions ?? (U.litHtmlVersions = [])).push('3.2.1')
      let td = (t, e, i) => {
          let s = (null == i ? void 0 : i.renderBefore) ?? e,
            r = s._$litPart$
          if (void 0 === r) {
            let t = (null == i ? void 0 : i.renderBefore) ?? null
            s._$litPart$ = r = new ts(e.insertBefore(x(), t), t, void 0, i ?? {})
          }
          return r._$AI(t), r
        },
        tc = class extends w {
      ...
      let tp = (t) => (e, i) => {
        ...
        t_ = { attribute: !0, type: String, converter: E, reflect: !1, hasChanged: b },
        t$ = (t = t_, e, i) => {
      ...
      function tE(t) {
        void 0 !== this._$AN ? (ty(this), (this._$AM = t), tS(this)) : (this._$AM = t)
      }
      function tb(t, e = !1, i = 0) {
        ...
        if (void 0 !== r && 0 !== r.size) {
          if (e) {
            if (Array.isArray(s)) for (let t = i; t < s.length; t++) tA(s[t], !1), ty(s[t])
            else null != s && (tA(s, !1), ty(s))
          } else tA(this, t)
        }
      }
      let tC = (t) => {
        t.type == tm.CHILD && (t._$AP ?? (t._$AP = tb), t._$AQ ?? (t._$AQ = tE))
      }
      class tw extends tv {
        constructor() {
      ...
      var tN,
        ...
        tI = (t, e, i, s) => {
          for (var r, n = s > 1 ? void 0 : s ? tR(e, i) : e, o = t.length - 1; o >= 0; o--)
            (r = t[o]) && (n = (s ? r(e, i, n) : r(n)) || n)
          return s && n && tT(e, i, n), n
        }
      let tx = class extends tc {
        constructor() {
          super(),
        ...
        handleMessageEvent(t) {
          ...
          if (
            ...
            if (null !== localStorage.getItem(this.GISCUS_SESSION_KEY)) {
              console.warn(`${this._formatError(i)} Session has been cleared.`), this.signOut()
              return
            }
            console.error(
  ...
  `),
        tI([tg({ reflect: !0 })], tx.prototype, 'host', 2),
        tI([tg({ reflect: !0 })], tx.prototype, 'repo', 2),
        tI([tg({ reflect: !0 })], tx.prototype, 'repoId', 2),
        tI([tg({ reflect: !0 })], tx.prototype, 'category', 2),
        tI([tg({ reflect: !0 })], tx.prototype, 'categoryId', 2),
        tI([tg({ reflect: !0 })], tx.prototype, 'mapping', 2),
        tI([tg({ reflect: !0 })], tx.prototype, 'term', 2),
        tI([tg({ reflect: !0 })], tx.prototype, 'strict', 2),
        tI([tg({ reflect: !0 })], tx.prototype, 'reactionsEnabled', 2),
        tI([tg({ reflect: !0 })], tx.prototype, 'emitMetadata', 2),
        tI([tg({ reflect: !0 })], tx.prototype, 'inputPosition', 2),
        tI([tg({ reflect: !0 })], tx.prototype, 'theme', 2),
        tI([tg({ reflect: !0 })], tx.prototype, 'lang', 2),
        tI([tg({ reflect: !0 })], tx.prototype, 'loading', 2),
        (tx = tI(
          [
            (function (t) {
